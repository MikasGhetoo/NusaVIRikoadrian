...
<head>
	...
	<title>Nusa V - The Team</title> <!-- < set your community's name here -->
...
<body>
	<header>
		<div class="wrapper">
			<nav>
				...
				<h2>Indonesia <span>Indonesia</span></h2> <!-- set your community name here --> 
				<div class="right">
		...
		<div class="wrapper">
			<div class="section-promo">
				<div class="promo-background">
					...
					<h1>Melayani & Melindungi Warga Nusa V Indonesia.</h1> <!-- set here title of the promo header -->
				</div>
			</div>
    ...
    <footer>
		<div class="wrapper">
			<p><h2>  [Nusa V Indonesia] </h2><br><h3>© 2023 Made By Dzullkz</h3></p>		</div>
	</footer>
